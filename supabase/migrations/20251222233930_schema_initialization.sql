...
CREATE TABLE IF NOT EXISTS group_memberships (
    ...
    joined_group_at TIMESTAMP NOT NULL DEFAULT NOW(),
...
CREATE TABLE IF NOT EXISTS account_group_visibility (
    id SERIAL PRIMARY KEY,
...
CREATE INDEX idx_account_users ON accounts (user_id);
...
CREATE INDEX idx_transaction_dates ON transactions (user_id, transaction_date DESC);
